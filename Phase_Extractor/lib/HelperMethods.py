...
def make_button(_master, _text, _command, _row=0, _column=0, _padx=5, _pady=5, _columnspan=1, _rowspan=1, _sticky=""):
...
def make_frame(_master, _row=0, _column=0, _padx=5, _pady=5, _columnspan=1, _rowspan=1, _raised=tk.FLAT):
	holder = tk.Frame(master=_master, borderwidth=5, relief= _raised)
	set_grid(holder,_row,_column,_columnspan, _rowspan, _padx, _pady,"nsew")
	return holder

def make_label(_master, _text="", _row=0, _column=0, _padx=5, _pady=5, _columnspan=1, _rowspan=1, _raised=tk.FLAT):
